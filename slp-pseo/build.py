"""
Programmatic SEO Compiler — SLP State Licensing Reference
...
if CONTENT_DIR.exists():
    ...
    for f in JSON_DIR.glob("*.json"):
        ...
        json_slugs.add(f"{d['state_slug']}.html")
...
print(f"  ROBOTS    dist/robots.txt")
...
<title>SLP License Requirements by State &mdash; Fees, Telepractice Rules &amp; How to Apply (2026)</title>
<meta name="description" content="Complete 2026 guide to speech-language pathologist (SLP) licensing requirements, telepractice rules, fees, and board contacts for all 50 US states and DC.">
<meta name="keywords" content="SLP license by state, speech-language pathology license requirements, SLP telepractice rules, state SLP board, SLP license cost, how to become an SLP">
<link rel="canonical" href="{DOMAIN}/">
<meta property="og:title" content="SLP License Requirements by State (2026)">
<meta property="og:description" content="Compare SLP licensing fees, telepractice rules, and application steps across all 50 states.">
...
<header class="hub-header">
  ...
  <h1>SLP License<br><em>State Directory</em></h1>
  <p>Stop decoding state board websites. Find your state\'s 2026 SLP licensing requirements, telepractice rules, board contacts, and step-by-step application roadmaps.</p>
  <div class="freshness">
