"""
Programmatic SEO Compiler — PT State Licensing Reference
...
if CONTENT_DIR.exists():
    ...
    for f in JSON_DIR.glob("*.json"):
        ...
        json_slugs.add(f"{d['state_slug']}-pt.html")
  ...
  <div class="footer-inner">
    <div class="footer-grid">
      <div>
        ...
        <p class="footer-tagline">Independent, YMYL-compliant licensing guides for physical therapists across the United States.</p>
      </div>
      <div>
        <div class="footer-col-title">Popular States</div>
        <ul class="footer-links">
          <li><a href="/california-pt">California</a></li>
          <li><a href="/texas-pt">Texas</a></li>
          <li><a href="/florida-pt">Florida</a></li>
          <li><a href="/new-york-pt">New York</a></li>
        </ul>
      </div>
      <div>
        <div class="footer-col-title">More States</div>
        <ul class="footer-links">
          <li><a href="/illinois-pt">Illinois</a></li>
          <li><a href="/ohio-pt">Ohio</a></li>
          <li><a href="/georgia-pt">Georgia</a></li>
          <li><a href="/pennsylvania-pt">Pennsylvania</a></li>
        </ul>
      </div>
    </div>
