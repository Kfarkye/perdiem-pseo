"""
Programmatic SEO Compiler — Pharm Tech State Licensing Reference
...
if CONTENT_DIR.exists():
    ...
    for f in JSON_DIR.glob("*.json"):
        ...
        json_slugs.add(f"{d['state_slug']}-pharm.html")
...
<title>Pharmacy Technician License Requirements by State &mdash; Fees, Board Contacts &amp; How to Apply (2026)</title>
<meta name="description" content="Complete 2026 guide to pharmacy technician licensing requirements, fees, and board contacts for all 50 US states and DC.">
<meta name="keywords" content="pharmacy technician license by state, pharmacy tech license requirements, CPhT licensure, state board of pharmacy, pharmacy tech license cost">
<link rel="canonical" href="{DOMAIN}/">
<meta property="og:title" content="Pharmacy Technician License Requirements by State (2026)">
<meta property="og:description" content="Compare pharmacy technician licensing fees, board contacts, and application steps across all 50 states.">
...
<header class="hub-header">
  ...
  <h1>Pharmacy Tech License<br><em>State Directory</em></h1>
  <p>Stop decoding state board websites. Find your state\'s 2026 pharmacy technician licensing requirements, fees, board contacts, and step-by-step application roadmaps.</p>
  <div class="freshness">
