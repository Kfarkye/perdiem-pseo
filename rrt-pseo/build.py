"""
Programmatic SEO Compiler — RRT State Licensing Reference
...
if CONTENT_DIR.exists():
    ...
    for f in JSON_DIR.glob("*.json"):
        ...
        json_slugs.add(f"{d['state_slug']}-rrt.html")
...
<title>Respiratory Therapist License Requirements by State &mdash; Fees, Board Contacts &amp; How to Apply (2026)</title>
<meta name="description" content="Complete 2026 guide to respiratory therapist (RRT) licensing requirements, fees, and board contacts for all 50 US states and DC.">
<meta name="keywords" content="RRT license by state, respiratory therapy license requirements, respiratory therapist licensure, state RT board, RRT license cost, how to become a respiratory therapist">
<link rel="canonical" href="{DOMAIN}/">
<meta property="og:title" content="Respiratory Therapist License Requirements by State (2026)">
<meta property="og:description" content="Compare respiratory therapist licensing fees, board contacts, and application steps across all 50 states.">
...
<header class="hub-header">
  ...
  <p>Stop decoding state board websites. Find your state\'s 2026 respiratory therapy licensing requirements, fees, board contacts, and step-by-step application roadmaps.</p>
  <div class="freshness">
  ...
  <div class="footer-inner">
    <div class="footer-grid">
      <div>
        ...
        <p class="footer-tagline">Independent, YMYL-compliant licensing guides for respiratory therapists across the United States.</p>
      </div>
      <div>
        <div class="footer-col-title">Popular States</div>
        <ul class="footer-links">
          <li><a href="/california-rrt">California</a></li>
          <li><a href="/texas-rrt">Texas</a></li>
          <li><a href="/florida-rrt">Florida</a></li>
          <li><a href="/new-york-rrt">New York</a></li>
        </ul>
      </div>
      <div>
        <div class="footer-col-title">More States</div>
        <ul class="footer-links">
          <li><a href="/illinois-rrt">Illinois</a></li>
          <li><a href="/ohio-rrt">Ohio</a></li>
          <li><a href="/georgia-rrt">Georgia</a></li>
          <li><a href="/pennsylvania-rrt">Pennsylvania</a></li>
        </ul>
      </div>
    </div>
