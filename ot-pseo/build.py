"""
Programmatic SEO Compiler — OT State Licensing Reference
...
if CONTENT_DIR.exists():
    ...
    for f in JSON_DIR.glob("*.json"):
        ...
        json_slugs.add(f"{d['state_slug']}-ot.html")
...
<title>OT License Requirements by State &mdash; Fees, Board Contacts &amp; How to Apply (2026)</title>
<meta name="description" content="Complete 2026 guide to occupational therapist (OT/OTR) licensing requirements, fees, and board contacts for all 50 US states and DC.">
<meta name="keywords" content="OT license by state, occupational therapy license requirements, OTR license requirements, state occupational therapy board, OT license cost, occupational therapist licensure">
<link rel="canonical" href="{DOMAIN}/">
<meta property="og:title" content="Occupational Therapist License Requirements by State (2026)">
<meta property="og:description" content="Compare OT licensing fees, board contacts, and application steps across all 50 states.">
...
<header class="hub-header">
  ...
  <h1>OT License<br><em>State Directory</em></h1>
  <p>Stop decoding state board websites. Find your state\'s 2026 OT/OTR licensing requirements, fees, board contacts, and step-by-step application roadmaps.</p>
  <div class="freshness">
